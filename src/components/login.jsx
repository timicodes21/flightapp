                        ...
                        <Row>
                            <div className="col-12">
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    ...
                                    <Form.Control required value={email} onChange={e => setEmail(e.target.value)} className="login-input p-3" type="email" placeholder="email" />
                                </Form.Group>
                            </div>
                            <div className="col-12">
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    <Form.Label><p className="font-14 text-green pt-1 font-500">Password</p></Form.Label>
                                    <Form.Control value={password} onChange={e => setPassword(e.target.value)} required className="login-input p-3" type={passwordShow ? "text" : "password"} placeholder="password" />
                                </Form.Group>
